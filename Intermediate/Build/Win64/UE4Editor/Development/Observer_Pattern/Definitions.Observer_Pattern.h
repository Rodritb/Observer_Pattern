...
#define UE_PROJECT_NAME Observer_Pattern
#define UE_TARGET_NAME Observer_PatternEditor
#define UE_MODULE_NAME "Observer_Pattern"
...
#define OBSERVER_PATTERN_API DLLEXPORT
